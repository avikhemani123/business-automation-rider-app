...
import 'package:riders_app2/mainScreens/parcel_delivering_screen.dart';
        ...
        children: [
          ...
          GestureDetector(
            onTap: ()
            {
              ...
              MapUtils.buildGoogleMapsURL(position!.latitude, position!.longitude, sellerLat, sellerLng);
            },
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
